...
public class XNetReplyTest extends jmri.jmrix.AbstractMessageTestBase {
   ...
   @Test
    ...
    public void testReplyConsumed() {
        ...
        XNetPlusReply r = new XNetPlusReply("E3 32 00 04 C5");
        ...
        // consume the action
        assertFalse("Action must be permitted", r.markConsumed(XNetPlusReply.CONSUMED_ACTION));
        assertTrue("Reply was consumed", r.isConsumed());
        assertTrue("Second action must be blocked", r.markConsumed(XNetPlusReply.CONSUMED_ACTION));
        ...
        assertFalse("Different action must be still OK", r.markConsumed(XNetPlusReply.CONSUMED_ACTION_EVEN));
    }
    ...
    public void testFeedbackReplyConsumedOnNonFeedback() {
        ...
        r = new XNetPlusReply("E3 32 00 04 C5");
    ...
    public void testFeedbackReplyConsumed() {
        XNetPlusReply r = new XNetPlusReply("42 05 48 0f");
        assertFalse("Initialy must not be consumed", r.isConsumed());
        assertFalse("Odd accessory action OK", r.isConsumed(r.getFeedbackConsumedBit(1)));
        assertFalse("Even accessory action OK", r.isConsumed(r.getFeedbackConsumedBit(2)));
