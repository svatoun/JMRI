 ...
 * @author sdedic
 */
public class XNetTurnoutMonitoringIT {
    private final static Logger log = LoggerFactory.getLogger(XNetTurnoutMonitoringIT.class);
        ...
        private void maybeWaitBeforeReply(XNetReply reply) {
            ...
            if (reply instanceof PrimaryXNetReply) {
                try {
                    ...
                    java.util.logging.Logger.getLogger(XNetTurnoutMonitoringIT.class.getName()).log(Level.SEVERE, null, ex);
                }
