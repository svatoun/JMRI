...
//    @Test
    public void testNormalMessages() throws Exception {
        ...
        lnis.sendMessage(m, callback);
        lnis.sendMessage(m2, callback);
        lnis.sendMessage(m3, callback);
...
//    @Test
    public void testSendPriorityMessages() throws Exception {
        ...
        XNetMessage m = XNetMessage.getCSVersionRequestMessage();       
        XNetMessage m2 = XNetMessage.getCSStatusRequestMessage();
        XNetMessage m3 = XNetMessage.getLocomotiveInfoRequestMsg(1).asPriority(true);
        XNetMessage m4 = XNetMessage.getCSVersionRequestMessage().asPriority(true);
        ...
        lnis.sendMessage(m2, callback);
        lnis.sendMessage(m3, callback);
        lnis.sendMessage(m4, callback);
        lnis.sendMessage(m5, callback);
