...
public class LenzPlusConnectionTypeList implements jmri.jmrix.ConnectionTypeList {
    ...
    public String[] getAvailableProtocolClasses() {
        return new String[] {
            "jmri.jmrix.lenzplus.config.LenzSerialConnectionConfig:LI100",
            "jmri.jmrix.lenzplus.config.LenzSerialConnectionConfig:liusb",
            "jmri.jmrix.lenzplus.config.LenzEthernetConnectionConfig:liusbEthernet",
        };
            /*
